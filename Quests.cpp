...
QuestStep::QuestStep(int32 in_id, int8 in_type, string in_description, vector<int32>* in_ids, int32 in_quantity, const char* in_task_group, vector<Location>* in_locations, float in_max_variation, float in_percentage, int32 in_itemid){
	type = in_type;
		...
		if(old_completed_quest) {
			...
			if (step->GetItemID() > 0) {
				...
				if (item) {
					...
					packet->setArrayDataByName("unknown2", item->details.item_id, 0);
					packet->PrintPacket();
				}
			}
...
QuestStep* Quest::AddQuestStep(int32 id, int8 in_type, string in_description, vector<int32>* in_ids, int32 in_quantity, const char* in_task_group, vector<Location>* in_locations, float in_max_variation, float in_percentage, int32 in_itemid){
	QuestStep* step = new QuestStep(id, in_type, in_description, in_ids, in_quantity, in_task_group, in_locations, in_max_variation, in_percentage, in_itemid);
