...
public:
	...
	static void SendHouseItemsList(Client* client, vector<PlayerHouse*> houses); //<<<<<<<<<<<<<<<<<<Change to house items list
	static void SendCharacterHousingList(Client* client, vector<PlayerHouse*> houses);
	static void SendPlayerHouseAccessUpdate(Client* client, bool access_delete, string access_name, int8 access_level);
