...
#define CF_COMBAT_EXPERIENCE_ENABLED	0 // 1
#define CF_ENABLE_CHANGE_LASTNAME		1 //2
#define CF_FOOD_AUTO_CONSUME			2 //4
#define CF_DRINK_AUTO_CONSUME			3 //8
#define CF_AUTO_ATTACK					4 //16
#define CF_RANGED_AUTO_ATTACK			5 //32
#define CF_QUEST_EXPERIENCE_ENABLED		6  //64
#define CF_CHASE_CAMERA_MAYBE			7  //128
#define CF_100							8//256
#define CF_200  9   //512
#define CF_IS_SITTING  10 /*CAN'T CAST OR ATTACK*///1024
#define CF_800  11 //2048
#define CF_ANONYMOUS  12//4096
#define CF_ROLEPLAYING  13//8192
#define CF_AFK  14  //16384
#define CF_LFG  15 //32768
#define CF_LFW  16 //65536
#define CF_HIDE_HOOD  17 //131072
#define CF_HIDE_HELM  18//262144
#define CF_SHOW_ILLUSION  19 //524288
#define CF_ALLOW_DUEL_INVITES  20 //1048576
#define CF_ALLOW_TRADE_INVITES  21//2097152
...
public:
	...
	EQ2Packet* serializeEquipSet(int16 version);
...
public:
	...
	bool				HasRecipeBook(string recipe_name);
	...
	bool				HasFreeMountSlot();
	int8				FindFreeMountSlot();
	...
	void UnlockTSSpells(int32 technique);
