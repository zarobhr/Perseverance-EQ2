...
#define SPELL_ERROR_NOT_ENOUGH_KNOWLEDGE					1 //8
#define SPELL_ERROR_INTERRUPTED								2 //11
#define SPELL_ERROR_TAKE_EFFECT_MOREPOWERFUL				3 //13
#define SPELL_ERROR_TAKE_EFFECT_SAMESPELL					4 //14
