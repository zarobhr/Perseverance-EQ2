...
public:
	...
	void CreateSpawn(string spawntype, int32 modeltype, int32 classtype, int32 level, string name, int32 difficulty, int32 size, Client* client,boolean houseitem);
	...
	void	AddMovementLocation(float x, float y, float z, float speed, int16 delay, const char* lua_function, boolean remove = 0);
