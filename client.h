...
public:
	...
	void	TourHouse(int32 zoneid);
	void	CreateSpawn(string spawntype, int32 modeltype, int32 classtype, int32 level, string name, int32 difficulty, int32 size, Client* client);
	void	ExitHouse();
	void	SendZoneInfo();
	void	SendZoneSpawns();
	...
	void	SendChangeServerControlFlagMsg(boolean flag, int16 version);
	...
	bool	SendCollectionsForItem(Item *item,int32 item_index);
