...
EQ2Packet* PlayerInfo::serialize(int16 version){
	...
	if(packet){
		...
		packet->setDataByName("status_points", info_struct->status_points);
		packet->setDataByName("unknown", info_struct->status_points);
		string* bind_name = 0;
		if(bind_zone_id > 0)
			bind_name = database.GetZoneName(bind_zone_id);
		if(bind_name){
		...
		packet->setDataByName("assigned_aa", player->GetAssignedAA()); //player->GetAssignedAA()
		packet->setDataByName("unassigned_aa", player->GetUnassignedAA());//player->GetUnassignedAA()
		packet->setDataByName("adv_xp_to_aa_xp_slider", 42);
		packet->setDataByName("bonus_achievement_xp", 61);
		packet->setDataByName("aa_towards_next", 51);
		packet->setDataByName("aa_green_bar", 51);
		packet->setDataByName("aa_blue_bar", 45);

		packet->setDataByName("items_found", 62); // these for AA exp gains
		packet->setDataByName("named_npcs_killed", 192);// these for AA exp gains
		packet->setDataByName("quests_completed", 670);// these for AA exp gains
		packet->setDataByName("exploration_events", 435);// these for AA exp gains
		packet->setDataByName("completed_collections", 144);// these for AA exp gains

		
		
		

		packet->setDataByName("unknown18a", 65535);
		packet->setDataByName("unknown18b", 32767);
		packet->setDataByName("unknown18c", 8191);
		packet->setDataByName("unknown18d", 4095);
		packet->setDataByName("unknown18e", 2047);
		packet->setDataByName("unknown18f", 1023);
		packet->setDataByName("unknown19", 16);
		packet->setDataByName("unknown20", 17);
		packet->setDataByName("unknown21", 18);
		packet->setDataByName("unknown24a", 19);
		packet->setDataByName("unknown23", 24);
		packet->setDataByName("unknown24a", 21);
		packet->setDataByName("unknown24b", 22);
		packet->setDataByName("unknown24b2", 23);
		packet->setDataByName("unknown24c1", 20);
		packet->setDataByName("unknown24c2", 25);
		packet->setDataByName("unknown24b1", 30);
		packet->setDataByName("unknown22", 27);
		packet->setDataByName("unknown24d", 28);
		packet->setDataByName("unknown24e", 29);
		packet->setDataByName("unknown25", 26);
		packet->setDataByName("unknown26", 31);
		packet->setDataByName("unknown27", 32);
		packet->setDataByName("unknown28", 33);
		packet->setDataByName("unknown29", 34);
		packet->setDataByName("unknown6307301", 35);
		packet->setDataByName("unknown6307302", 36);
		packet->setDataByName("unknown30", 37);
		packet->setDataByName("unknown31", 38);
		packet->setDataByName("unknown32", 39);
		packet->setDataByName("unknown33", 40);
		...
		packet->setDataByName("mentor_bonus", 88);
		packet->setDataByName("server_bonus", 89);
		packet->setDataByName("adventure_vet_bonus", 90);
		packet->setDataByName("tradeskill_vet_bonus", 91);
		packet->setDataByName("dungeon_finder_bonus", 92);
		packet->setDataByName("recruit_friend_bonus", 93);
		packet->setDataByName("recruit_friend", 94);

		packet->setDataByName("current_adv_xp", info_struct->xp);
		packet->setDataByName("needed_adv_xp", info_struct->xp_needed);
		packet->setDataByName("debt_adv_xp", .2);// will we be implementing debt this is multipled x100 in client
		packet->setDataByName("adventure_vitality", (int16)(player->GetXPVitality() * 10)); // fixed CS
		packet->setDataByName("adventure_vitality_yellow_arrow", 53);//need fixed CS
		packet->setDataByName("adventure_vitality_blue_arrow", 54); //ok need to code
		packet->setDataByName("xp_yellow_vitality_bar", info_struct->xp_yellow_vitality_bar);
		packet->setDataByName("xp_blue_vitality_bar", info_struct->xp_blue_vitality_bar);
		
		
		packet->setDataByName("current_trade_xp", info_struct->ts_xp);
		packet->setDataByName("needed_trade_xp", info_struct->ts_xp_needed);
		packet->setDataByName("debt_trade_xp", .3);// will we be implement debt this is multipled x100 in client
		packet->setDataByName("tradeskill_vitality", 59);//100
		packet->setDataByName("tradeskill_vitality_purple_arrow", 60);
		packet->setDataByName("tradeskill_vitality_blue_arrow", 61);
		...
		*/
		...
		packet->setDataByName("unknown14d", 74, 0);
	...
	//		packet->setDataByName("unknown7", 257, i);
		...
		*/
		...
		packet->setDataByName("crit_success_mod", 109);//9.5
		packet->setDataByName("ability_mod", info_struct->ability_modifier);
		packet->setDataByName("unknown199a",111);//25
		packet->setDataByName("unknown199b", 112);//30
		packet->setDataByName("unknown199c", 113);//45
		packet->setDataByName("unknown199d", 114);//55
		packet->setDataByName("critical_mit", info_struct->critical_mitigation);//info_struct->critical_mitigation
		...
		packet->setDataByName("potency", 119);//info_struct->potency);//player->stats[ITEM_STAT_POTENCY]
		...
		packet->setDataByName("spell_reuse_speed", info_struct->recovery_speed);
		packet->setDataByName("spell_multi_attack", info_struct->spell_multi_attack);
		packet->setDataByName("ability_doublecast", info_struct->spell_multi_attack);
		...
		packet->setDataByName("flurry", 133);//info_struct->multi_attack // this not right??
		...
		packet->setDataByName("refine_quantity_mod", player->stats[ITEM_STAT_EX_SUCCESS_MOD]);
		packet->setDataByName("bountiful_harvest", 496);//tes charsheet fix
		//packet->setDataByName("unknown132", 132);//tes charsheet fix
		//packet->setDataByName("unknown133", 133);//tes charsheet fix
		//packet->setDataByName("unknown134", 134);//tes charsheet fix
		//packet->setDataByName("unknown136", 136);//tes charsheet fix
		//packet->setDataByName("unknown139", 139);//tes charsheet fix
		//packet->setDataByName("unknown140", 140);//tes charsheet fix
		//packet->setDataByName("unknown141", 141);//tes charsheet fix
		//packet->setDataByName("unknown142", 142);//tes charsheet fix
		//packet->setDataByName("unknown143", 143);//tes charsheet fix
		//packet->setDataByName("unknown144", 144);//tes charsheet fix
		//packet->setDataByName("unknown145", 145);//tes charsheet fix
		//packet->setDataByName("unknown146", 146);//tes charsheet fix
		//packet->setDataByName("unknown147", 147);//tes charsheet fix
		//packet->setDataByName("unknown148", 148);//tes charsheet fix
		//packet->setDataByName("unknown149", 149);//tes charsheet fix
		//packet->setDataByName("unknown150", 150);//tes charsheet fix
		//packet->setDataByName("unknown151", 151);//tes charsheet fix
		//packet->setDataByName("unknown152", 152);//tes charsheet fix
		//packet->setDataByName("unknown153", 153);//tes charsheet fix
		//packet->setDataByName("unknown154", 154);//tes charsheet fix
		//packet->setDataByName("unknown155", 155);//tes charsheet fix
		//packet->setDataByName("unknown156", 156);//tes charsheet fix
		//packet->setDataByName("unknown157", 157);//tes charsheet fix
		//packet->setDataByName("unknown159", 159);//tes charsheet fix
		//packet->setDataByName("unknown160", 160);//tes charsheet fix
		//packet->setDataByName("unknown161", 161);//tes charsheet fix
		//packet->setDataByName("unknown162", 162);//tes charsheet fix
		//packet->setDataByName("unknown163", 163);//tes charsheet fix
		//packet->setDataByName("unknown164", 164);//tes charsheet fix
		//packet->setDataByName("unknown165", 165);//tes charsheet fix
		//packet->setDataByName("unknown166", 166);//tes charsheet fix
		//packet->setDataByName("unknown167", 167);//tes charsheet fix
		//packet->setDataByName("unknown168", 168);//tes charsheet fix
		//packet->setDataByName("unknown463", 463);//tes charsheet fix
		//packet->setDataByName("unknown464", 464);//tes charsheet fix
		//packet->setDataByName("unknown465", 465);//tes charsheet fix
		//packet->setDataByName("unknown466", 466);//tes charsheet fix
		//packet->setDataByName("unknown467", 467);//tes charsheet fix
		//packet->setDataByName("unknown468", 468);//tes charsheet fix
		//packet->setDataByName("unknown470", 470);//tes charsheet fix
		//packet->setDataByName("unknown471", 471);//tes charsheet fix
		//packet->setDataByName("unknown472", 472);//tes charsheet fix
		//packet->setDataByName("unknown473", 473);//tes charsheet fix
		//packet->setDataByName("unknown474", 474);//tes charsheet fix
		//packet->setDataByName("unknown475", 475);//tes charsheet fix
		//packet->setDataByName("unknown476", 476);//tes charsheet fix
		//packet->setDataByName("unknown477", 477);//tes charsheet fix
		//packet->setDataByName("unknown478", 478);//tes charsheet fix
		//packet->setDataByName("unknown479", 479);//tes charsheet fix
		//packet->setDataByName("unknown480", 480);//tes charsheet fix
		//packet->setDataByName("unknown481", 481);//tes charsheet fix
		//packet->setDataByName("unknown482", 482);//tes charsheet fix
		//packet->setDataByName("unknown483", 483);//tes charsheet fix
		//packet->setDataByName("unknown484", 484);//tes charsheet fix
		//packet->setDataByName("unknown485", 485);//tes charsheet fix
		//packet->setDataByName("unknown486", 486);//tes charsheet fix
		//packet->setDataByName("unknown487", 487);//tes charsheet fix
		//packet->setDataByName("unknown488", 488);//tes charsheet fix
		//packet->setDataByName("unknown489", 489);//tes charsheet fix
		//packet->setDataByName("unknown490", 490);//tes charsheet fix
		//packet->setDataByName("unknown491", 491);//tes charsheet fix
		//packet->setDataByName("unknown492", 492);//tes charsheet fix
		//packet->setDataByName("unknown493", 493);//tes charsheet fix
		//packet->setDataByName("unknown494", 494);//tes charsheet fix
		//packet->setDataByName("unknown495", 495);//tes charsheet fix
...
EQ2Packet* PlayerInfo::serializeEquipSet(int16 version) {
	PacketStruct* packet = configReader.getStruct("WS_EquipmentSets", version);
	if (packet) {
		packet->setDataByName("category", "adventuring");
		packet->setArrayLengthByName("set_count", 4);
		packet->setArrayDataByName("set_name", "adventuring", 0);
		packet->setArrayDataByName("set_name", "harvesting", 1);
		packet->setArrayDataByName("set_name", "naked", 2);
		packet->setArrayDataByName("set_name", "resolve", 3);
		packet->setDataByName("selected_set", 3);


		string* data = packet->serializeString();
		int32 size = data->length();
		uchar* tmp = new uchar[size];
		EQ2Packet* ret_packet = new EQ2Packet(OP_EquipmentSets, tmp, size + 4);
		safe_delete(packet);
		safe_delete_array(tmp);
		return ret_packet;
	}
...
void Player::UnlockTSSpells(int32 technique) {
	...
	for (itr = spells.begin(); itr != spells.end(); itr++) {
		if ((*itr)->type == SPELL_BOOK_TYPE_TRADESKILL){
			Spell* spell = master_spell_list.GetSpell((*itr)->spell_id, (*itr)->tier);
			int32 mastery = spell->GetSpellData()->mastery_skill;
			if (mastery == technique)
				ModifySpellStatus(*itr, 66);
		}
	}
	MSpellsBook.releasewritelock(__FUNCTION__, __LINE__);
...
vector<int32> Player::GetSpellBookSpellIDBySkill(int32 skill_id) {
	...
	for(itr = spells.begin(); itr != spells.end(); itr++){
		...
		if(spell && spell->GetSpellData()->mastery_skill == skill_id)
			ret.push_back(spell->GetSpellData()->id);//change id to soe_spell_crc
	}	
	MSpellsBook.releasereadlock(__FUNCTION__, __LINE__);
...
void Player::SetNeededXP(){
	...
	if (level > 100)
		SetNeededXP(m_levelXPReq[100] * ((level - 100) + 1));
	else
...
vector<Item*>* Player::GetPendingLootItems(int32 id){
	...
	if(pending_loot_items.count(id) > 0){
		...
		for(itr = pending_loot_items[id].begin(); itr != pending_loot_items[id].end(); itr++){
			LogWrite(PLAYER__DEBUG, 0, "Player", "I hav a pending loot item" );
...
bool Player::HasFreeMountSlot() {
	return item_list.HasFreeMountSlot();
}

int8 Player::FindFreeMountSlot() {
	return item_list.FindFreeMountSlot();
}
...
void Player::InitGXPTable() {
	m_levelGXPReq[3] = 5500;
	m_levelGXPReq[4] = 8500;
	m_levelGXPReq[5] = 12100;
	m_levelGXPReq[6] = 16600;
	m_levelGXPReq[7] = 22300;
	m_levelGXPReq[8] = 29500;
	m_levelGXPReq[9] = 38500;
	m_levelGXPReq[10] = 49600;
	m_levelGXPReq[11] = 63100;
	m_levelGXPReq[12] = 79300;
	m_levelGXPReq[13] = 98500;
	m_levelGXPReq[14] = 121000;
	m_levelGXPReq[15] = 147100;
	m_levelGXPReq[16] = 177100;
	m_levelGXPReq[17] = 211300;
	m_levelGXPReq[18] = 250000;
	m_levelGXPReq[19] = 293500;
	m_levelGXPReq[20] = 342100;
	m_levelGXPReq[21] = 396100;
	m_levelGXPReq[22] = 455800;
	m_levelGXPReq[23] = 521500;
	m_levelGXPReq[24] = 593500;
	m_levelGXPReq[25] = 672100;
	m_levelGXPReq[26] = 757600;
	m_levelGXPReq[27] = 850300;
	m_levelGXPReq[28] = 950500;
	m_levelGXPReq[29] = 1058500;
	m_levelGXPReq[30] = 1174600;
	m_levelGXPReq[31] = 1299100;
	m_levelGXPReq[32] = 1432300;
	m_levelGXPReq[33] = 1574500;
	m_levelGXPReq[34] = 1726000;
	m_levelGXPReq[35] = 1887100;
	m_levelGXPReq[36] = 2058100;
	m_levelGXPReq[37] = 2239300;
	m_levelGXPReq[38] = 2431000;
	m_levelGXPReq[39] = 2633500;
	m_levelGXPReq[40] = 2847100;
	m_levelGXPReq[41] = 3072100;
	m_levelGXPReq[42] = 3308800;
	m_levelGXPReq[43] = 3557500;
	m_levelGXPReq[44] = 3818500;
	m_levelGXPReq[45] = 4092100;
	m_levelGXPReq[46] = 4378600;
	m_levelGXPReq[47] = 4678300;
	m_levelGXPReq[48] = 4991500;
	m_levelGXPReq[49] = 5318500;
	m_levelGXPReq[50] = 5659600;
	m_levelGXPReq[51] = 6015100;
	m_levelGXPReq[52] = 6385300;
	m_levelGXPReq[53] = 6770500;
	m_levelGXPReq[54] = 7169700;
	m_levelGXPReq[55] = 7581900;
	m_levelGXPReq[56] = 8006100;
	m_levelGXPReq[57] = 8441300;
	m_levelGXPReq[58] = 8886500;
	m_levelGXPReq[59] = 9341700;
	m_levelGXPReq[60] = 9806900;
	m_levelGXPReq[61] = 10282100;
	m_levelGXPReq[62] = 10767300;
	m_levelGXPReq[63] = 11262500;
	m_levelGXPReq[64] = 11767700;
	m_levelGXPReq[65] = 12282900;
	m_levelGXPReq[66] = 12808100;
	m_levelGXPReq[67] = 13343300;
	m_levelGXPReq[68] = 13888500;
	m_levelGXPReq[69] = 14443700;
	m_levelGXPReq[70] = 15008900;
	m_levelGXPReq[71] = 15584100;
	m_levelGXPReq[72] = 16169300;
	m_levelGXPReq[73] = 16764500;
	m_levelGXPReq[74] = 17369700;
	m_levelGXPReq[75] = 17984900;
	m_levelGXPReq[76] = 18610100;
	m_levelGXPReq[77] = 19245300;
	m_levelGXPReq[78] = 19890500;
	m_levelGXPReq[79] = 20545700;
	m_levelGXPReq[80] = 21210900;
	m_levelGXPReq[81] = 21886100;
	m_levelGXPReq[82] = 22569300;
	m_levelGXPReq[83] = 23258500;
	m_levelGXPReq[84] = 23951700;
	m_levelGXPReq[85] = 24646900;
	m_levelGXPReq[86] = 25342100;
	m_levelGXPReq[87] = 26037300;
	m_levelGXPReq[88] = 26732500;
	m_levelGXPReq[89] = 27427700;
	m_levelGXPReq[90] = 28122900;
	m_levelGXPReq[91] = 28818100;
	m_levelGXPReq[92] = 29513300;
	m_levelGXPReq[93] = 30208500;
	m_levelGXPReq[94] = 30903700;
	m_levelGXPReq[95] = 31598900;
	m_levelGXPReq[96] = 32294100;
	m_levelGXPReq[97] = 32989300;
	m_levelGXPReq[98] = 33684500;
	m_levelGXPReq[99] = 34379700;
	m_levelGXPReq[100] = 35074900;
...
void Player::InitXPTable() {
	...
	m_levelXPReq[91] = 518156;
	m_levelXPReq[92] = 757500;
	m_levelXPReq[93] = 871125;
	m_levelXPReq[94] = 984750;
	m_levelXPReq[95] = 1098375;
	m_levelXPReq[96] = 1212000;
	m_levelXPReq[97] = 1325625;
	m_levelXPReq[98] = 1439250;
	m_levelXPReq[99] = 1552875;
	m_levelXPReq[100] = 1666500;
