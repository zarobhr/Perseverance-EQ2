...
void ClientPacketFunctions::SendItemCreationUI(Client* client, Recipe* recipe) {
	...
	packet->setDataByName("product_byproduct_name", "testme");
	...
	for (itr = spells.begin(); itr != spells.end(); itr++) {
		size++;
		Spell* spellTS = master_spell_list.GetSpell(*itr,0); //master_spell_list.GetSpell((*itr)->id);
	...
	//	strcat(str, temp);
	//	strcat(str, "_id");
		int32 myspell = master_spell_list.GetSpell(*itr, 1)->GetSpellID();
		int8 myindex = master_spell_list.GetSpell(*itr, 1)->GetTSIndex()-1;
	packet->setDataByName("skill_id", myspell, myindex);
	//packet->setDataByName("skill1_id", 9003);
	//	packet->setDataByName("skill2_id", 9018);
	//	packet->setDataByName("skill3_id", 9070);
	//	packet->setDataByName("skill4_id", 9041);
	//	packet->setDataByName("skill5_id", 9082);
	//	packet->setDataByName("skill6_id", 9088);
}
