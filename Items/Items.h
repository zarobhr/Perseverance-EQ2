...
#define ITEM_MENU_TYPE_TEST11			2147483648//31
...
public:
	...
	struct HouseItem_Info{
		...
		int8					house_only;
		int32					model_id;
		int32					primary_command;
		int32					secondary_command;
		int8					location_allowed;
	};
...
//	map< int8, Item* > bank_items;
	...
	void  MoveMountItem(Item* item, sint32 inv_slot, int16 slot, bool erase_old = true);
	bool  MoveMountItem(sint32 to_bag_id, int16 from_index, sint8 to);
	...
	bool GetFirstMountSlot(sint32* bag_id, sint16* slot);
